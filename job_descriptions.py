...
JOB_DESCRIPTIONS = [
    ...
    },
    {
        "key": "commis-chef",
        "title": "Commis Chef",
        "purpose": "To support the kitchen team in the preparation and cooking of food to the required standard, learning each section of the kitchen under the guidance of senior chefs. As an entry-level chef role, the focus is on developing skills, maintaining a clean and organised station, and helping deliver consistent, high-quality dishes to our customers.",
        "duties": [
            "Prepare ingredients for service, including washing, peeling, chopping and portioning as directed.",
            "Assist senior chefs in the preparation and cooking of dishes across all sections of the kitchen.",
            "Follow recipes, portion sizes and presentation standards set by the Head or Sous Chef.",
            "Set up, stock and clean your workstation before, during and after each service.",
            "Ensure ingredients and supplies at your station are fresh, correctly stored and available for service.",
            "Support the smooth running of service by working quickly and accurately under supervision.",
            "Label, date and store food correctly, following stock rotation (FIFO) principles.",
            "Assist with receiving and putting away deliveries, checking for quality and quantity.",
            "Maintain strict health, hygiene and food safety standards at all times.",
            "Help minimise food waste and use resources responsibly.",
            "Learn and develop skills across different kitchen sections as directed.",
            "Assist with basic cleaning duties and dishwashing when required.",
        ],
        "skills": [
            "Some experience in a kitchen or hospitality role is preferred but not essential — a willingness to learn is most important.",
            "A genuine interest in food and pursuing a career as a chef.",
            "Basic food preparation and knife skills, or the aptitude to learn them quickly.",
            "Understanding of, or willingness to learn, food safety and hygiene standards.",
            ...
            "Availability to work in shifts, including evenings, weekends and public holidays.",
            "A relevant cookery qualification (or working towards one) is an advantage.",
        ],
    },
    {
        "key": "chef-de-partie",
